				...
				<div class="col-md-12">
					...
					<div class="box box-primary">
						<div class="box-header with-border">
							<h3 class="box-title">放映编辑</h3>
						</div>

						<!-- /.box-header -->
						<!-- form start -->
						<form role="form" method="post" action="{{ url('/admin/project/update') }}" enctype="multipart/form-data" >
							...
							<div class="box-body">
								...
								<div class="form-group">
									...
									<select name="cinema_id" class="form-control">
										<option value="0">{{ $data ->cinema_id  }}</option>
								...
								<div class="form-group">
									...
									<select name="hall_id" class="form-control">
										<option value="0">{{ $data ->hall_id  }}</option>
								...
								<div class="form-group">
									...
									<select name="movie_id" class="form-control">
										<option value="0">{{ $data ->movie_id  }}</option>
								...
								<div class="form-group">
									...
									<select name="date_id" class="form-control">
										<option value="0">{{ $data ->date_id }}</option>
								...
								<div class="form-group">
									...
									<select name="time_id" class="form-control">
										<option value="0">{{ $data ->time_id }}</option>
