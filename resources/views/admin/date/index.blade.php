				...
				<div class="col-xs-12">
					<div class="box">
						<div class="box-header">
							<h3 class="box-title">快速查看日期列表</h3>
						</div>
						<!-- /.box-header -->
						<div class="box-body">
							...
							<form action="{{ url('/admin/date/index') }}" method="get">
								<div class="row">
									<div class="col-md-2">
										<!-- select --> 
							...
							<table id="example2" class="table table-bordered table-hover">
								...
								<tbody>
									...
									<tr class="parent">
										...
										<td class="name">{{ $val -> date_name }}</td>
										<td >{{ $val -> week_name }}</td>
										<td><a href="{{ url('/admin/date/edit') }}/{{ $val -> id }}">编辑</a> <a href="{{ url('/admin/date/delete') }}/{{ $val -> id }}">删除</a></td>
									</tr>
									@endforeach
								</tbody>
							</table>
