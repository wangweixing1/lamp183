  ...
  <div id="YFocus">
    <div id="YImage">
    	<div class="xiongdilian">
			<br/>个人中心
      <p>
        用户：<button class="btn btn-danger" type="button">{{ $session -> name }}</button>
      </p>
			</div><br />
				<div class="zuobian">
            ...
            @endif
                ...
                @if(session('info'))
                 ...
                 @endif
				<div class="youbian">
					<div class="nicheng">用户名&nbsp;:<input type="text" name="name" value="{{ $data -> name }}" size="20px" placeholder="请输入昵称" /></div><br/>
					<div class="youxiang">邮&nbsp;&nbsp;&nbsp;&nbsp;箱&nbsp;:<input type="email" name="email" value="{{ $data -> email }}" size="20px" placeholder="请输入邮箱" /></div><br/>
