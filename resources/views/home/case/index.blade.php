...
<div class="contenter">
 ...
 <div class="pbanner">
     ...
     <div class="product_search" style="padding-top:15px;">
        	<table cellspacing="0" cellpadding="0" border="0" class="pro_tab">
              <tbody><tr>
                <td width="11%"><a title="橱窗式" class="p_icon1" href="#"></a>&nbsp;<a title="列表式" class="p_icon2_1" href="#"></a></td>
                <td width="6%">搜索：</td>
                <td>
                ...
                <input type="submit" value="搜索" id="button" name="button"></td>
              </tr>
            </tbody></table>
        </div>
