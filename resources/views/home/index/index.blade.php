...
<div class="banner">
  <div id="YFocus">
    <div id="YImage">
      <p id="YPhotos"> <a href="#" title="11"><img src="homelte/images/b5.jpg" alt="11" /></a> <a href="#" title="11"><img src="homelte/images/b1.jpg" alt="111" /></a> <a href="#" title="11"><img src="homelte/images/b3.jpg" alt="22" /></a> <a href="#" title="1"><img src="homelte/images/b4.jpg" alt="22" /></a> </p>
    </div>
    <p id="YSamples"> <a href="#1" class="current" title="2"><img src="homelte/images/bx5.jpg" alt="22" /></a> <a href="#1" title="2"><img src="homelte/images/bx1.jpg" alt="2" /></a> <a href="#1" title="2"><img src="homelte/images/bx3.jpg" alt="2" /></a> <a href="#1" title="2"><img src="homelte/images/bx4.jpg" alt="2" /></a> </p>
  </div>
  ...
  <div class="left">
    <div class="left_1">
      ...
      <div class="left_1_con">
        ...
        <div class="left_1_r">
          <h3>即将播出影片</h3>
          <dl>
            <dt><a href="#"><img src="homelte/images/newspic.jpg" width="80" height="65" /></a></dt>
    ...
    <div class="left_6 top10px">
      ...
      <div class="left_6_con">
        <dl class="fx_list">
          <dt><img src="homelte/images/fx1.jpg" width="65" height="65" /></dt>
          <dd><strong>霸气抢票第e波 </strong><br />
            -<a href="#">--《四大名捕》火热抢票送不停 抢票时间：7月16日-7月22日 </a></dd>
        </dl>
        <dl class="fx_list">
          <dt><img src="homelte/images/fx12.jpg" width="65" height="65" /></dt>
          <dd><strong>给力活动第一期 </strong><br />
            <a href="#">---《给力火车》给力送票送不停 活动时间：7月19日-7月28日 </a></dd>
        </dl>
        <dl class="fx_list">
          <dt><img src="homelte/images/fx13.jpg" width="65" height="65" /></dt>
    ...
    <div class="right_1">
      ...
      <div class="inner02">
        <dl style="border-bottom:0px #fff solid;">
          <dt><img src="homelte/images/fa1.gif" width="56" height="45" /></dt>
        ...
        <dl style="border-bottom:0px #fff solid;">
          <dt><img src="homelte/images/fa2.gif" width="56" height="45" /></dt>
          <dd style=" padding-top:10px;">
            <select name="">
        ...
        <dl  style="border-bottom:0px #fff solid;">
          <dt><img src="homelte/images/fa3.gif" width="56" height="45" /></dt>
          <dd style=" padding-top:10px;">
            <select name="">
        ...
        <dl>
          <dt><img src="homelte/images/fa4.gif" width="56" height="45" /></dt>
          <dd style=" padding-top:10px;">
            <input name="" type="button" class="dgbg" value="立即订购" />
          </dd>
          <div class="clear"></div>
        </dl>
        <div class="wxpd"><a href="#"><img src="homelte/images/104.jpg" /></a></div>
      </div>
    </div>
    ...
    <div class="right_5 top10px">
      ...
      <div class="inner022">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="135" align="center" width="140"><a href="#"><img src="homelte/images/index_r_03_seo.gif" width="120" height="100" /></a></td>
            <td><a href="#">超凡蜘蛛侠</a><p>主演:成龙、谢霆锋</p></td>
          </tr>
          <tr>
            <td height="135" align="center" width="140"><a href="#"><img src="homelte/images/index_r_03_seo2.gif" width="120" height="100" /></a></td>
