...
<div class="header" >
  <div class="top_img">
    ...
    <div class="top_nav">
      ...
      <p><a href="{{ url('/home/center') }}"> 个人中心 </a></p>
    </div>
    <div class="clear"></div>
  </div>
  <div class="menu">
        ...
        <div class="left_1_l">
          <div class="scrolldoorFrame">
            <ul class="scrollUl">
             @foreach($carousel as $key => $val)
              ...
              <a href="#">
                ...
                <dl class="hd_list">
                  <dt><img src="/uploads/movie_img/{{ $val -> carousel_img }}" width="81" height="35" /></dt>
                  <dd>{{ $val ->carousel_name }}</dd>
                  <dd>7月13日上映>></dd>
                </dl>
                </a></li>
                @endforeach
            ...
            <div class="cont">
              ...
              <div id="c01"><img src="/uploads/movie_img/{{ $val -> carousel_img }}" width="449" height="193" /></div>
